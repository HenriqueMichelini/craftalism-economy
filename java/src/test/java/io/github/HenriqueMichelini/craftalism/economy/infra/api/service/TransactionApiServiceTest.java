...
class TransactionApiServiceTest {
    ...
    void shouldRegisterTransactionSuccessfully()
        ...
        TransactionResponseDTO result = service
            .register(fromUuid, toUuid, testAmount)
            .get();

        assertNotNull(result);
        assertEquals(transactionId, result.id());
        assertEquals(fromUuid, result.fromPlayerUuid());
        assertEquals(toUuid, result.toPlayerUuid());
    ...
    void shouldRegisterTransactionWithMinimumAmount()
        throws ExecutionException, InterruptedException {
        long minAmount = 1L;
        ...
        TransactionResponseDTO result = service
            .register(fromUuid, toUuid, minAmount)
            .get();
    ...
    void shouldRegisterTransactionWithVeryLargeAmount()
        throws ExecutionException, InterruptedException {
        ...
        TransactionResponseDTO result = service
            .register(fromUuid, toUuid, largeAmount)
            .get();
    ...
    void shouldRegisterTransactionWithSameSenderAndReceiver()
        throws ExecutionException, InterruptedException {
        ...
        TransactionResponseDTO result = service
            .register(sameUuid, sameUuid, testAmount)
            .get();

        assertEquals(sameUuid, result.fromPlayerUuid());
        assertEquals(sameUuid, result.toPlayerUuid());
    }
    ...
    void shouldHandleHttpErrorOnRegisterTransaction() {
        ...
        CompletableFuture<TransactionResponseDTO> result = service.register(
            fromUuid,
            toUuid,
            testAmount
        );
    ...
    void shouldSerializeTransactionRequestCorrectly()
        throws ExecutionException, InterruptedException {
    ...
    void shouldDeserializeTransactionResponseCorrectly()
        throws ExecutionException, InterruptedException {
        Long expectedId = 42L;
    ...
    void shouldHandleMultipleConcurrentRegistrations()
        ...
        TransactionResponseDTO response1 = new TransactionResponseDTO(
            1L,
            from1,
            to1,
            amount1,
        ...
        TransactionResponseDTO response2 = new TransactionResponseDTO(
            2L,
            from2,
            to2,
            amount2,
        ...
        HttpResponse<String> mockResponse1 = createMockResponse(
            201,
            gson.toJson(response1)
        );
        HttpResponse<String> mockResponse2 = createMockResponse(
            201,
        ...
        CompletableFuture<TransactionResponseDTO> future2 = service.register(
            from2,
            to2,
            amount2
        );
    ...
    void shouldReturnTransactionWithCorrectTimestamp()
        throws ExecutionException, InterruptedException {
    ...
    private HttpResponse<String> createMockResponse(
        int statusCode,
        String body
    ) {
